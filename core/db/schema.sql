...
CREATE TABLE IF NOT EXISTS runtime_policy (
    ...
    graphflow_worker_count          INTEGER NOT NULL DEFAULT 10,
    graphflow_max_active_jobs       INTEGER NOT NULL DEFAULT 10,
    opencode_concurrency            INTEGER NOT NULL DEFAULT 10,
    graphflow_max_cpu_percent       REAL NOT NULL DEFAULT 90,
    graphflow_max_memory_percent    REAL NOT NULL DEFAULT 90,
